# React Game of Thrones Database

**Watch => https://kalashnikovtv.github.io/GameOfThrones-DB/**

## Database Game of Thrones

The database is based on the [API of Ice And Fire](https://anapioficeandfire.com/).
